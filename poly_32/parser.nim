...
proc transform*(p: var Polyhedron, t: char, n: int32 = 0, f1: float32 = 0.0,
        f2: float32 = 0.0) =
...
# string transform
proc transform*(p: Polyhedron, tr: string, n: int32 = 0, f1: float32 = 0.1,
        f2: float32 = 0.0, limit_vertex:int32): Polyhedron =
...
# scan tt..tP
proc transform*(s: string, limit_vertex :int32): Polyhedron =
    transform(polychar(s[^1]), s[0 .. ^2], limit_vertex = limit_vertex ) # last char is poly seed rest in transformation
